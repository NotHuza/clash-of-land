<appSettings>
  ...
  <add key="UpdateUrl" value="http://antzps.ddns.net/downloads/" />
  <!-- Location to redirect outdated player-->
  <add key="MaintenanceTime" value="20" />
  <!-- Maintenance Time in Minutes-->
  <add key="PatchUrl" value="http://antzps.ddns.net/Patchs/" />
  <!-- Location of your patching server-->
  <add key="EventsUrl" value="http://antzps.ddns.net/events/" />
